                ...
                ?>
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100 blog-card">
                            <img src="uploads/artikel/<?php echo htmlspecialchars($row['gambar_header'] ?? 'default-artikel.png'); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($row['judul_artikel']); ?>">
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title"><?php echo htmlspecialchars($row['judul_artikel']); ?></h5>
                                <p class="card-text text-muted small">
                                    Oleh <?php echo htmlspecialchars($row['nama_guru']); ?> | <?php echo date('d F Y', strtotime($row['tanggal_dibuat'])); ?>
                                </p>
                                <p class="card-text">
                                    <?php echo htmlspecialchars(substr(strip_tags($row['isi_artikel']), 0, 100)); ?>...
                                </p>
                                <a href="artikel_detail.php?id=<?php echo $row['id_artikel']; ?>" class="btn btn-primary mt-auto">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                <?php

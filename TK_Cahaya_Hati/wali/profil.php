...
$stmt = $conn->prepare("SELECT nama_wali, username, foto_profil FROM wali_murid WHERE id_wali = ?");
    ...
    <div class="form-container">
        <form action="proses_profil.php" method="POST" enctype="multipart/form-data">
            <div class="profile-picture-preview">
                <img src="../uploads/profil/<?php echo htmlspecialchars($wali['foto_profil']); ?>" alt="Foto Profil" id="preview_img">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php echo htmlspecialchars($wali['nama_wali']); ?>" disabled>
            </div>
            <div class="form-group">
                <label>Username</label>
                <input type="text" value="<?php echo htmlspecialchars($wali['username']); ?>" disabled>
            </div>
